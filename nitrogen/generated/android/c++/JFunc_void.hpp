...
namespace margelo::nitro::calendar {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/calendar/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/calendar/Func_void_cxx;";
